docker build . -t sabbour/captureorderack-netcore:v6
docker push sabbour/captureorderack-netcore:v6
...
-e EVENTHUBNAME='ehub' \
-e APPINSIGHTS_KEY='db755b02-c972-4f4d-ae93-cccbd98403c9' sabbour/captureorderack-netcore:v4
